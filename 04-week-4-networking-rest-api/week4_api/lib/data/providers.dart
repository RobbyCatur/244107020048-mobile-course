...
/// Detail satu post via GET /posts/:id. Dipakai halaman detail sebagai
/// fallback ketika dibuka langsung (deep link) dan post belum ada di
/// list yang termuat. Exception otomatis menjadi AsyncError.
